...
try:
    ...
    class SetupFileIsMissing(Exception):
        pass
    raise SetupFileIsMissing(
        'Please make a setpyenv.json file in the root directory.')
...
def load_yaml_config(path_configuration):
    try:
        ...
        class SetupFileIsMissing(Exception):
            pass
        raise SetupFileIsMissing(
            'Please make a pipeline_config.yaml file in the root directory.')
